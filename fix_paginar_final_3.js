...
// The regex replacement failed previously.
// Let's replace the paginarConteudo manually string based.

let funcStart = content.indexOf('function paginarConteudo(html, baixaVisao, fatorZoom)');
let funcEnd = content.indexOf('// ============================================================', funcStart);
// But wait, there is a comment:
// // RECEBER MENSAGENS
// Let's find that.
let receiveMsg = content.indexOf('// RECEBER MENSAGENS', funcStart);
funcEnd = content.lastIndexOf('// ============================================================', receiveMsg);

let oldPaginar = content.substring(funcStart, funcEnd);
...
content = content.replace(oldPaginar, newPaginarConteudo);
